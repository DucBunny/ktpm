...
public class EditCollectionPeriodsController {
    // Left
    @FXML
    ...
    private static CollectionPeriods collectionPeriodsToEdit;

    public static void setCollectionPeriodsToEdit(CollectionPeriods collectionPeriods) {
        collectionPeriodsToEdit = collectionPeriods;
    }
    ...
    public void initialize() {
        ...
        // Set dữ liệu nếu có
        //        if (collectionPeriodsToEdit != null) {
        //            fullNameField.setText(collectionPeriodsToEdit.getFullName());
        //            placeOfBirthField.setText(collectionPeriodsToEdit.getPlaceOfBirth());
        //            occupationField.setText(collectionPeriodsToEdit.getOccupation() != null ? collectionPeriodsToEdit.getOccupation() : "");
        //            phoneField.setText(collectionPeriodsToEdit.getPhone() != null ? collectionPeriodsToEdit.getPhone() : "");
        //            setComboBoxValue(genderBox, collectionPeriodsToEdit.getGender(), true);
        //            setComboBoxValue(roomBox, collectionPeriodsToEdit.getRoomNumber(), false);
        //
        //            hometownField.setText(collectionPeriodsToEdit.getHometown());
        //            ethnicityField.setText(collectionPeriodsToEdit.getEthnicity());
        //            idCardNumberField.setText(collectionPeriodsToEdit.getIdCardNumber());
        //            setComboBoxValue(relationshipBox, collectionPeriodsToEdit.getRelationshipToOwner(), true);
        //            setComboBoxValue(residenceStatusBox, collectionPeriodsToEdit.getResidenceStatus(), true);
        //            setComboBoxValue(statusBox, collectionPeriodsToEdit.getStatus(), true);
        //
        //            // Gán giá trị ngày sinh
        //            if (collectionPeriodsToEdit.getDateOfBirth() != null) {
        //                int day = collectionPeriodsToEdit.getDateOfBirth().getDayOfMonth();
        //                int month = collectionPeriodsToEdit.getDateOfBirth().getMonthValue();
        //                int year = collectionPeriodsToEdit.getDateOfBirth().getYear();
            ...
            try (Connection connection = DatabaseConnection.getConnection()) {
                ...
                try {
                    ...
                    try (PreparedStatement checkStmt = connection.prepareStatement(checkSql)) {
                        ...
                        checkStmt.setInt(2, collectionPeriodsToEdit.getId());
