...
public class RoomDetailController {
    ...
    @FXML private Label ownerField;
    @FXML private Label roomName;     // fx:id="roomName"
    @FXML private Label roomCode;     // fx:id="roomCode"
    @FXML private Label roomArea;     // fx:id="roomArea"
    @FXML private Label roomStatus;   // fx:id="roomStatus"

    // ==== Bảng Danh sách cư dân ====
    @FXML private TableView<Residents> tableResidents;     // fx:id="tableResidents"
    @FXML private TableColumn<Residents, Integer> colSTT;  // fx:id="colSTT"
    @FXML private TableColumn<Residents, String> colHoTen; // fx:id="colHoTen"
    @FXML private TableColumn<Residents, String> colQuanHe; // fx:id="colQuanHe"
    @FXML private TableColumn<Residents, LocalDate> colNgaySinh; // fx:id="colNgaySinh"
    @FXML private TableColumn<Residents, String> colGioiTinh; // fx:id="colGioiTinh"
    @FXML private TableColumn<Residents, String> colCCCD;    // fx:id="colCCCD"
    @FXML private TableColumn<Residents, String> colSDT;     // fx:id="colSDT"
    @FXML private TableColumn<Residents, Void> colAction;
    ...
    public void loadRoomData() {
        try {
            ...
            if (resultSet.next()) {
                ...
                Room room = new Room(Integer.parseInt(soNha), maCan, dienTich, tinhTrang);
    ...
    public void handleEditRoomDetail(Room room) {
        try {
            Stage owner = StageManager.getPrimaryStage();
