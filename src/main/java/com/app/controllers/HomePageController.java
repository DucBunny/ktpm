...
public class HomePageController {
    ...
    public void initialize(String role, String username) throws SQLException, IOException {
        this.role = role;
    ...
    public void exportReport() throws IOException {
        Stage owner = StageManager.getPrimaryStage();
        SceneNavigator.showPopupScene("/fxml/export-report.fxml", "/styles/Payments/crud-payment.css", owner);
    }
}
